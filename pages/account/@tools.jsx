...
export function ToolItem( { name, size, icon, onClick } ) {
    const 
        ...
        enter = () => setDisplay( 'show-i' ),
        out = () => setDisplay( 'hide-i' );
    return (
        <div className="d-flex flex-row tool-item justify-content-center align-items-center mb-3" onClick={ onClick } onMouseEnter={ enter } onMouseLeave={ out } onMouseUp={ out }>
